...
export function LoginModal({ isOpen, onOpenChange }: LoginModalProps) {
  const { verifyOtp, signInWithGoogle } = useAuth();
            ...
            {step === "phone" && (
              ...
              >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-3 rounded-xl border border-border bg-muted hover:bg-muted/70 text-foreground font-semibold flex items-center justify-center gap-2.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
