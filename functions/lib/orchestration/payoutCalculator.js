...
exports.computePayoutAmount = computePayoutAmount;
const logger_1 = require("../utils/logger");
const PAYOUT_SLAB_TABLE = [
    // Moderate severity
 ...
 */
async function computePayoutAmount(claimContext) {
 ...
 * Calculate exposure duration in hours
 */
function calculateExposureHours(triggerEvent) {
 ...
 */
function findMatchingSlab(severity, exposureHours) {
 ...
 */
function calculateRemainingProtection(policy) {
...
//# sourceMappingURL=payoutCalculator.js.map